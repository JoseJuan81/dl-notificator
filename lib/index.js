(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.DlNotificator = {}, global.functionallibrary));
  ...
  var Notification = /*#__PURE__*/function () {
    ...
    */
    ...
    _createClass(Notification, [{
      key: "add",
      value: function add(notiOptions) {
        var firstChild = this.container.firstChild;
        var div = this.createNotificationElement(notiOptions);
        this.container.insertBefore(div, firstChild);
      }
    }, {
      key: "createNotificationElement",
      value: function createNotificationElement(notiOptions) {
        var _this = this;
        ...
        div.addEventListener('animationend', function (ev) {
          ...
          if (animationName === "entering-".concat(_this.uuid)) {
            ...
            _this.removeNotification.call(_this, div);
          }
        });
      ...
      key: "error",
      value: function error(errorOptions) {
        var errorOpt = typeof errorOptions === 'string' ? functionallibrary.setNewProperty('message', errorOptions, this.errorOpts) : functionallibrary.mergeObjects(this.errorOpts, errorOptions);
        this.add(errorOpt);
      }
      /**
       *
      ...
      key: "info",
      value: function info(infoOptions) {
        var infoOpt = typeof infoOptions === 'string' ? functionallibrary.setNewProperty('message', infoOptions, this.infoOpts) : functionallibrary.mergeObjects(this.infoOpts, infoOptions);
        this.add(infoOpt);
      }
    }, {
      ...
      value: function removeNotification(el) {
      ...
      value: function success() {
        ...
        var successOpt = typeof successOptions === 'string' ? functionallibrary.setNewProperty('message', successOptions, this.successOpts) : functionallibrary.mergeObjects(this.successOpts, successOptions);
        this.add(successOpt);
      }
      /**
       *
      ...
      value: function warning() {
        ...
        var warningOpt = typeof warningOptions === 'string' ? functionallibrary.setNewProperty('message', warningOptions, this.warningOpts) : functionallibrary.mergeObjects(this.warningOpts, warningOptions);
        this.add(warningOpt);
      }
    }]);
